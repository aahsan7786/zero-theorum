...
} from "../../../store/charts/rollingNetFlow/actions";
...
const RollingNetFlow = (props) => {
  ...
  useEffect(() => {
    const {api, fetchRollingNetFlowSuccess, fetchRollingNetFlowError, data} =
      props;
    if (isEmpty(data)) {
      fetchData(
        api.getRollingNetFlow,
        fetchRollingNetFlowSuccess,
        fetchRollingNetFlowError,
  ...
  return (
    <Fragment>
      <InfoModalGraph
        ...
        text={
          "Calculating the Net aggregate BTC\n" +
      ...
      <Plot
        ...
        layout={
          viewSettingsLayout(
            ...
            0.5,
            "Date",
            "Net Quantity of BTC Transferred",
            "stack",
            "percent",
            true,
            true
...
export default WithApiService()(
  connect(mapStateToProps, mapDispatchToProps)(RollingNetFlow)
);
