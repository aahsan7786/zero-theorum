...
} from "Store/charts/autocorrelation/actions";
...
const Autocorrelation = (props) => {
  ...
  useEffect(() => {
    const {api, fetchAutoCorrelationSuccess, fetchAutoCorrelationError, data} =
      props;
    if (isEmpty(data)) {
      fetchData(
        api.getAutocorrelation,
        fetchAutoCorrelationSuccess,
        fetchAutoCorrelationError
      );
    }
  ...
  return (
    <Fragment>
      <InfoModalGraph
        ...
        text={
          "Autocorrelation explores the relationship\n" +
...
export default WithApiService()(
  connect(mapStateToProps, mapDispatchToProps)(Autocorrelation)
);
