...
} from "../../../store/charts/BTCReturnDistribution/actions";
...
export default WithApiService()(
  connect(mapStateToProps, mapDispatchToProps)(BTCReturnHistogram)
);
