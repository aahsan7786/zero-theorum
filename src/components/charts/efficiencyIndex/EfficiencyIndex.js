...
} from "Store/charts/hodlerDistribution/actions";
...
const EfficiencyIndex = (props) => {
  ...
  const onChangeFilter = (startDate) => {
    const {api, fetchHodlerDistributionSuccess, fetchHodlerDistributionError} =
      props;
    fetchData(
      api.getHodlerDistribution,
      fetchHodlerDistributionSuccess,
...
export default WithApiService()(
  connect(mapStateToProps, mapDispatchToProps)(EfficiencyIndex)
);
