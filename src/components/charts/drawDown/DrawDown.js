...
const DrawDown = (props) => {
    ...
    const {isLoading, data: {date, PctDrawdown}} = props;
    ...
    return (
        <Fragment>
            ...
            onClick={() => setScroll(true)}
                ...
                layout={viewSettingsLayout(`${hours} Hour Drawdown`, true, {
                    l: 40,
                    r: 30,
                    t: 95,
                    b: 30
                }, '', '%y/%d/%m', 0.5, 'Date', 'Percentage Loss', 'stack', 'percent', true, true).layout}
...
export default WithApiService()(connect(mapStateToProps, mapDispatchToProps)(DrawDown));
