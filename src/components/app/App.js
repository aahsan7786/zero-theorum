      ...
      <Router>
        ...
        <Switch>
          ...
          <Switch>
            ...
            <Route exact path="/research/13" component={ArticleThirteen} />
            <Route exact path="/research/14" component={ArticleFourteen} />
            <Route exact path="/research/15" component={ArticleFifteen} />
            <Route exact path="/research/16" component={ArticleSixteen} />
            <Route exact path="/research/17" component={ArticleSeventeen} />
            <Route exact path="/research/18" component={ArticleEighteen} />
            <Route exact path="/research/19" component={ArticleNineteen} />
          </Switch>
          {/*<Route path="/research">*/}
          {/*    <Research/>*/}
          {/*</Route>*/}
