...
const Accuracy = (props) => {
  return (
    <section className="section hero accuracy-page">
              ...
              <div className="row">
                ...
                <div className="col-xl-12">
                  <div className="download-block">
                    Download raw data from your specified backtest here.
                    <br />
                    Please note each download requires users to complete a quick
                    google survey.
                    <div className="download-button">
                      Zero_Theorem_Backtest.csv
                    </div>
                  </div>
                </div>
              </div>
