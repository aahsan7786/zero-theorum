...
const TrendDecompose = (props) => {
    ...
    const {isLoading, data: {date, trend}} = props;
    ...
    return (
        <Fragment>
            ...
            <Plot
                ...
                layout={viewSettingsLayout('Seasonal Decompose', true, {l: 40, r: 30, t: 95, b: 30}, '', '', 0.5, 'Time', '', '', '', true, true).layout}
...
export default WithApiService()(connect(mapStateToProps, mapDispatchToProps)(TrendDecompose));
