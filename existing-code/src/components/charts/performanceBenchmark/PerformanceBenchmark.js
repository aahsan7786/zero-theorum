...
const PerformanceBenchmark = (props) => {
    ...
    const {isLoading, data: {date, zt_cum_perf, btc_cum_perf}} = props;
    ...
    return (
        <Fragment>
            ...
            onClick={() => setScroll(true)}
                ...
                layout={viewSettingsLayout(`${hours} Hour Performance Benchmark`, true, {
                    l: 40,
                    r: 30,
                    t: 95,
                    b: 30
                }, '', '', 0.5, 'Date', 'Portfolio Value (USD)', 'stack', 'percent', true, true).layout}
...
export default WithApiService()(connect(mapStateToProps, mapDispatchToProps)(PerformanceBenchmark));
